                    ...
                    <h1 className=" text-black text-base font-bold md:text-xl lg:text-2xl lg:mb-2 xl:text-3xl xl:mb-4 2xl:text-7xl 2xl:mb-8">Create Exam</h1>
                        ...
                        <div className="grid grid-cols-2 lg:gap-6 xl:gap-10 2xl:gap-20 border-2 ">
                            ...
                            <div className="flex items-center 2xl:justify-between">
                                <label className="text-sm  md:text-base lg:w-1/3 lg:text-xl xl:w-1/3 xl:text-2xl 2xl:w-1/2 2xl:text-6xl border-2 " htmlFor="daysImageDiagnosos">Days Since Dx</label>
                                <input className="lg:text-xl xl:text-2xl 2xl:text-6xl" type="text" name="daysImageDiagnosos" id="daysImageDiagnosos" onChange={(e) => handleInputChanges(e)}/>
                            </div>
                            <div className="flex items-center 2xl:justify-between">
                                <label className="text-sm  md:text-base lg:w-1/3 lg:text-xl xl:w-1/3 xl:text-2xl 2xl:w-1/2 2xl:text-6xl border-2" htmlFor="hrsImageDiagnosis">Hrs Since Dx</label>
                                <input className="lg:text-xl xl:text-2xl 2xl:text-6xl" type="text" name="hrsImageDiagnosis" id="hrsImageDiagnosis" onChange={(e) => handleInputChanges(e)}/>
                            </div>
                            <div className="flex items-center 2xl:justify-between">
                                <label className="text-sm  md:text-base lg:w-1/3 lg:text-xl xl:w-1/3 xl:text-2xl 2xl:w-1/2 2xl:text-6xl border-2" htmlFor="imageDescription">Decribe Image</label>
                                <input className="lg:text-xl xl:text-2xl 2xl:text-6xl" type="text" name="imageDescription" id="imageDescription" onChange={(e) => handleInputChanges(e)}/>
                            </div>
                            <div className="flex items-center 2xl:justify-between">
                                <label className="text-sm  md:text-base lg:w-1/3 lg:text-xl xl:w-1/3 xl:text-2xl 2xl:w-1/2 2xl:text-6xl border-2" htmlFor="findings">Key Findings</label>
                                <input className="lg:text-xl xl:text-2xl 2xl:text-6xl" type="text" name="findings" id="findings" onChange={(e) => handleInputChanges(e)}/>
                            </div>
                            <div className="flex items-center 2xl:justify-between">
                                <label className="text-sm  md:text-base lg:w-1/3 lg:text-xl xl:w-1/3 xl:text-2xl 2xl:w-1/2 2xl:text-6xl border-2" htmlFor="modality">Modality</label>
                                <input className="lg:text-xl xl:text-2xl 2xl:text-6xl" type="text" name="modality" id="modality" onChange={(e) => handleInputChanges(e)}/>
                            </div>
                            <div className="flex items-center 2xl:justify-between">
                                <label className="text-sm  md:text-base lg:w-1/3 lg:text-xl xl:w-1/3 xl:text-2xl 2xl:w-1/2 2xl:text-6xl border-2" htmlFor="fio">Fio</label>
