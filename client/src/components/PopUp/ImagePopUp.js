...
export default function ImagePopUp ({visible, onClose, item}) {
                        ...
                        <div className='bg-white px-2 py-4 rounded-lg w-full  shadow-xl h-auto'>
                            ...
                            <div className=' h-auto '>
                                <div className='flex flex-col h-full '>
                                    ...
                                    <img className="rounded" src={item.imageURL} alt={`exam image with ${item.keyFindings}`}/>
                                </div>
                            </div>                             
                        </div>
                    </div>
