...
export const  Login2 = ({patientId, open, onClose}) => {
  return (
    <>
        <div className="fixed flex flex-col justify-center items-center top-0 left-0 w-full h-full mx-auto border-2 ">
            <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 max-w-xs md:max-w-2xl xl::max-w-4xl xl:p-0 ">
