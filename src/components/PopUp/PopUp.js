            ...
            {pageData.map(function (item) {
                return (
                    <div className="flex justify-center items-center fixed inset-0 bg-black bg-opacity-30 backdrop-blur-sm p-2">
                        <div className='bg-white p-4 rounded-lg w-full space-y-1'>
                            ...
                            <button className='border rounded-full p-2 shadow-lg' onClick={onClose}><GrClose className='text-gray-600 font-bold'/></button>                                
                        </div>
