      ...
      <div className=" max-w-full mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 text-base md:text-2xl font-bold">
          ...
          <div class="flex items-center w-1/2 justify-center relative md:hidden">
            ...
            <button type="submit" class="text-white absolute right-1.5  bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm px-2 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"><FaSearch/></button>
          </div>
